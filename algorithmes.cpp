...
void random_array(int A[], int B[], int C[], int length)
{
    int i;
    for(i = 0; i < length; i++)
    {
        A[i] = B[i] = C[i] = 1 + rand() % RANDOM;
    };
}
...
int main()
{
    ...
    random_array(array_5_1, array_5_2, array_5_3, Num_5);
    ...
    free(array_5_3);
    printf("5 \t %2.6f \t %2.6f \t %2.6f \n", bubble_time_5/CLOCKS_PER_SEC, merging_time_5/CLOCKS_PER_SEC, quick_time_5/CLOCKS_PER_SEC);
    ...
    random_array(array_10_1, array_10_2, array_10_3, Num_10);
    ...
    free(array_10_3);
    printf("10 \t %2.6f \t %2.6f \t %2.6f \n", bubble_time_10/CLOCKS_PER_SEC, merging_time_10/CLOCKS_PER_SEC, quick_time_10/CLOCKS_PER_SEC);
    ...
    random_array(array_100_1, array_100_2, array_100_3, Num_100);
    ...
    free(array_100_3);
    printf("100 \t %2.6f \t %2.6f \t %2.6f \n", bubble_time_100/CLOCKS_PER_SEC, merging_time_100/CLOCKS_PER_SEC, quick_time_100/CLOCKS_PER_SEC);
    ...
    random_array(array_1k_1, array_1k_2, array_1k_3, Num_1k);
    ...
    free(array_1k_3);
    printf("1k \t %2.6f \t %2.6f \t %2.6f \n", bubble_time_1k/CLOCKS_PER_SEC, merging_time_1k/CLOCKS_PER_SEC, quick_time_1k/CLOCKS_PER_SEC);
    ...
    random_array(array_10k_1, array_10k_2, array_10k_3, Num_10k);
    ...
    free(array_10k_3);
    printf("10k \t %2.6f \t %2.6f \t %2.6f \n", bubble_time_10k/CLOCKS_PER_SEC, merging_time_10k/CLOCKS_PER_SEC, quick_time_10k/CLOCKS_PER_SEC);
    ...
    random_array(array_100k_1, array_100k_2, array_100k_3, Num_100k);
    ...
    free(array_100k_3);
    printf("100k \t %2.5f \t %2.6f \t %2.6f \n", bubble_time_100k/CLOCKS_PER_SEC, merging_time_100k/CLOCKS_PER_SEC, quick_time_100k/CLOCKS_PER_SEC);
    ...
    random_array(array_1M_1, array_1M_2, array_1M_3, Num_1M);
    ...
    random_array(array_10M_1, array_10M_2, array_10M_3, Num_10M);
    ...
    random_array(array_100M_1, array_100M_2, array_100M_3, Num_100M);
